...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA3     ------> ADC1_IN4
    */
    HAL_GPIO_DeInit(SENS_4_GPIO_Port, SENS_4_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PB2     ------> ADC2_IN12
    */
    HAL_GPIO_DeInit(GPIOA, HAL_1_Pin|HAL_2_Pin|HAL_3_Pin|HAL_4_Pin);

    HAL_GPIO_DeInit(SENS_3_GPIO_Port, SENS_3_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PB1     ------> ADC3_IN1
    */
    HAL_GPIO_DeInit(GPIOB, SENS_1_Pin|SENS_2_Pin);
